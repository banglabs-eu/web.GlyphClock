(function () {
    ...
    var T = {
        ...
        'about.addon': {
            en: 'Also available as a <a href="https://addons.mozilla.org/en-US/firefox/addon/glyphclock/">Firefox add-on</a>.',
            bg: 'Налично и като <a href="https://addons.mozilla.org/en-US/firefox/addon/glyphclock/">добавка за Firefox</a>.',
            hr: 'Dostupno i kao <a href="https://addons.mozilla.org/en-US/firefox/addon/glyphclock/">Firefox dodatak</a>.',
            cs: 'K dispozici také jako <a href="https://addons.mozilla.org/en-US/firefox/addon/glyphclock/">doplněk pro Firefox</a>.',
            da: 'Også tilgængelig som en <a href="https://addons.mozilla.org/en-US/firefox/addon/glyphclock/">Firefox-tilføjelse</a>.',
            nl: 'Ook beschikbaar als <a href="https://addons.mozilla.org/en-US/firefox/addon/glyphclock/">Firefox-add-on</a>.',
            et: 'Saadaval ka <a href="https://addons.mozilla.org/en-US/firefox/addon/glyphclock/">Firefoxi lisandina</a>.',
            fi: 'Saatavilla myös <a href="https://addons.mozilla.org/en-US/firefox/addon/glyphclock/">Firefox-lisäosana</a>.',
            fr: 'Également disponible en tant qu\'<a href="https://addons.mozilla.org/en-US/firefox/addon/glyphclock/">extension Firefox</a>.',
            de: 'Auch verfügbar als <a href="https://addons.mozilla.org/en-US/firefox/addon/glyphclock/">Firefox-Add-on</a>.',
            el: 'Διαθέσιμο και ως <a href="https://addons.mozilla.org/en-US/firefox/addon/glyphclock/">πρόσθετο Firefox</a>.',
            hu: 'Elérhető <a href="https://addons.mozilla.org/en-US/firefox/addon/glyphclock/">Firefox-bővítményként</a> is.',
            ga: 'Ar fáil freisin mar <a href="https://addons.mozilla.org/en-US/firefox/addon/glyphclock/">breiseán Firefox</a>.',
            it: 'Disponibile anche come <a href="https://addons.mozilla.org/en-US/firefox/addon/glyphclock/">componente aggiuntivo per Firefox</a>.',
            lv: 'Pieejams arī kā <a href="https://addons.mozilla.org/en-US/firefox/addon/glyphclock/">Firefox papildinājums</a>.',
            lt: 'Taip pat prieinamas kaip <a href="https://addons.mozilla.org/en-US/firefox/addon/glyphclock/">Firefox priedas</a>.',
            mt: 'Disponibbli wkoll bħala <a href="https://addons.mozilla.org/en-US/firefox/addon/glyphclock/">add-on tal-Firefox</a>.',
            pl: 'Dostępne również jako <a href="https://addons.mozilla.org/en-US/firefox/addon/glyphclock/">dodatek do Firefoksa</a>.',
            pt: 'Também disponível como <a href="https://addons.mozilla.org/en-US/firefox/addon/glyphclock/">extensão para Firefox</a>.',
            ro: 'Disponibil și ca <a href="https://addons.mozilla.org/en-US/firefox/addon/glyphclock/">supliment Firefox</a>.',
            sk: 'K dispozícii aj ako <a href="https://addons.mozilla.org/en-US/firefox/addon/glyphclock/">doplnok pre Firefox</a>.',
            sl: 'Na voljo tudi kot <a href="https://addons.mozilla.org/en-US/firefox/addon/glyphclock/">dodatek za Firefox</a>.',
            es: 'También disponible como <a href="https://addons.mozilla.org/en-US/firefox/addon/glyphclock/">complemento de Firefox</a>.',
            sv: 'Finns även som <a href="https://addons.mozilla.org/en-US/firefox/addon/glyphclock/">Firefox-tillägg</a>.',
            ja: '<a href="https://addons.mozilla.org/en-US/firefox/addon/glyphclock/">Firefoxアドオン</a>としてもご利用いただけます。'
        },
        'about.creator': {

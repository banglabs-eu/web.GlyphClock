(function () {
    ...
    var T = {
        ...
        'title.why': {
            en: 'Why GlyphClock Works | GlyphClock',
            bg: 'Защо GlyphClock работи | GlyphClock',
            hr: 'Zašto GlyphClock funkcionira | GlyphClock',
            cs: 'Proč GlyphClock funguje | GlyphClock',
            da: 'Hvorfor GlyphClock virker | GlyphClock',
            nl: 'Waarom GlyphClock werkt | GlyphClock',
            et: 'Miks GlyphClock toimib | GlyphClock',
            fi: 'Miksi GlyphClock toimii | GlyphClock',
            fr: 'Pourquoi GlyphClock fonctionne | GlyphClock',
            de: 'Warum GlyphClock funktioniert | GlyphClock',
            el: 'Γιατί το GlyphClock λειτουργεί | GlyphClock',
            hu: 'Miért működik a GlyphClock | GlyphClock',
            ga: 'Cén fáth a n-oibríonn GlyphClock | GlyphClock',
            it: 'Perché GlyphClock funziona | GlyphClock',
            lv: 'Kāpēc GlyphClock darbojas | GlyphClock',
            lt: 'Kodėl GlyphClock veikia | GlyphClock',
            mt: 'Għaliex GlyphClock jaħdem | GlyphClock',
            pl: 'Dlaczego GlyphClock działa | GlyphClock',
            pt: 'Porque o GlyphClock funciona | GlyphClock',
            ro: 'De ce funcționează GlyphClock | GlyphClock',
            sk: 'Prečo GlyphClock funguje | GlyphClock',
            sl: 'Zakaj GlyphClock deluje | GlyphClock',
            es: 'Por qué GlyphClock funciona | GlyphClock',
            sv: 'Varför GlyphClock fungerar | GlyphClock',
            ja: 'GlyphClockが機能する理由 | GlyphClock'
        },

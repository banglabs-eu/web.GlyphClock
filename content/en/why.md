{
  "layout": "why",
  "title": "Why GlyphClock Works | GlyphClock",
  "description": "Why replacing clock precision with symbolic time blocks improves focus, creativity, and coordination.",
  "heading": "Why GlyphClock Works",
  "paragraphs": [
  ...
  "refs_intro": "GlyphClock comes from how I work. The model reflects what actually holds up in practice: the research mostly confirms it rather than defining it.",
  "refs_lineswith": "If you want the background, it lines up with:",
  "refs_list": "<li>Thompson: clock time as a tool for industrial coordination</li><li>Kleitman, Lavie: natural ~90-minute rhythms in human alertness</li><li>Ericsson: focused work happens in bounded sessions with breaks</li><li>Zakay: monitoring time consumes attention</li><li>Amabile: time pressure reduces creative thinking</li><li>Paivio: visual + verbal encoding improves recall</li>",
  "refs_closing": "These aren’t the source of the idea. They just point in the same direction.",
  "footer": "<a href=\"index.html\">Back to GlyphClock</a> &middot; Created by <a href=\"https://bang-labs.eu\" class=\"banglabs-brand\">Bang Labs</a>."
}

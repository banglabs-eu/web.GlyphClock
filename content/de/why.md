{
  ...
  "refs_heading": "Referenzen",
  "refs_intro": "GlyphClock kommt von meiner Arbeitsweise. Das Modell spiegelt wider, was tatsächlich in der Praxis standhält: die Forschung bestätigt es größtenteils, anstatt es zu definieren.",
  "refs_lineswith": "Wenn Sie den Hintergrund möchten, es stimmt überein mit:",
  "refs_list": "<li>Thompson: Uhrzeit als Werkzeug industrieller Koordination</li><li>Kleitman, Lavie: natürliche ~90-Minuten-Rhythmen in der menschlichen Wachheit</li><li>Ericsson: fokussierte Arbeit findet in begrenzten Sitzungen mit Pausen statt</li><li>Zakay: Zeitüberwachung verbraucht Aufmerksamkeit</li><li>Amabile: Zeitdruck reduziert kreatives Denken</li><li>Paivio: visuelle + verbale Kodierung verbessert die Erinnerung</li>",
  "refs_closing": "Sie sind nicht die Quelle der Idee. Sie zeigen nur in dieselbe Richtung.",
  "footer": "<a href=\"index.html\">Zurück zu GlyphClock</a> &middot; Erstellt von <a href=\"https://bang-labs.eu\" class=\"banglabs-brand\">Bang Labs</a>."
}
